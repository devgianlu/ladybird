...
// https://w3c.github.io/webcrypto/#rsa-pss-registration
WebIDL::ExceptionOr<GC::Ref<JS::ArrayBuffer>> RSAPSS::sign(AlgorithmParams const&, GC::Ref<CryptoKey> key, ByteBuffer const&)
{
    auto& realm = *m_realm;
    ...
    // 6. Return signature.
    return WebIDL::OperationError::create(realm, "Not implemented"_string); // TODO
}

// https://w3c.github.io/webcrypto/#rsa-pss-registration
WebIDL::ExceptionOr<JS::Value> RSAPSS::verify(AlgorithmParams const&, GC::Ref<CryptoKey> key, ByteBuffer const&, ByteBuffer const&)
{
    auto& realm = *m_realm;
